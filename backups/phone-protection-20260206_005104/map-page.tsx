...
import { Search, MapPin, Navigation, Filter, List as ListIcon, Map as MapIcon, Briefcase, Clock, DollarSign, Tag, Phone, Star } from 'lucide-react'
                  ...
                  providers.map(provider => (
                    ...
                    >
                      ...
                      {provider.phoneNumber && (
                        <div className="mt-2 pt-2 border-t border-slate-100 flex items-center text-xs text-slate-500">
              ...
              >
                <div className="p-2 min-w-[240px] max-w-[300px]">
                  ...
                  {selectedProvider.phoneNumber && (
                    <div className="mb-3 flex items-center text-sm text-slate-600 bg-slate-50 px-3 py-2 rounded-lg">
                      <Phone className="w-4 h-4 mr-2 text-slate-400" />
                      <a href={`tel:${selectedProvider.phoneNumber}`} className="text-indigo-600 hover:underline no-underline font-medium">
                        {selectedProvider.phoneNumber}
                      </a>
                    </div>
                  )}
