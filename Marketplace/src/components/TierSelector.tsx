...
const tiers = [
  {
    ...
    name: 'Безплатен',
    price: '0 лв',
    features: ['2 категории', '5 снимки', 'Пробен период']
  },
  {
    id: 'normal' as const,
    name: 'Нормален',
    price: '349 лв/година (с ДДС)',
    features: ['5 категории', '20 снимки', '350 точки/година', 'До 1500 лв бюджет'],
    recommended: true
  },
  {
    id: 'pro' as const,
    name: 'Професионален',
    price: '489 лв/година (с ДДС)',
    features: ['Неограничено', '100 снимки', '500 точки/година', 'Всички бюджети', 'Наддаване']
  }
]
